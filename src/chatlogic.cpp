...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            (*parentNode)->AddEdgeToChildNode(std::move(edge)); //change to move semantics for unique_ptr
                            //what should happen to edge in _edges
                        }
    ...
    ChatBot chatBot("../images/chatbot.png"); //this creates chat bot on stack, not new/delete or smart pointer that'd
